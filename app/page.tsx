...
import { ArrowRight, Leaf, Droplets, Crown, Star, CheckCircle } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <section className="hero-gradient min-h-screen flex items-center relative overflow-hidden">
        ...
        <div className="absolute inset-0" style={{background:'linear-gradient(135deg,rgba(26,15,0,0.7) 0%,rgba(61,43,10,0.5) 100%)'}}/>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 pt-24 pb-16 grid md:grid-cols-2 gap-12 items-center">
          <div className="text-white fade-in">
            ...
            <p className="font-body text-lg text-white/80 leading-relaxed mb-10 max-w-lg">
              Des formules naturelles et puissantes, conçues avec amour pour les cheveux crépus, bouclés et frisés. Parce que chaque cheveu mérite d&apos;être traité comme de l&apos;or.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-12">
              {['Livraison express','Sans sulfates','Vegan & naturel','Paiement sécurisé'].map(item => (
      ...
      <section className="bg-[#F5F0EA] py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((val, i) => (
              <div key={i} className="text-center p-8 bg-white hover:shadow-xl transition-shadow duration-300">
      ...
      {/* BRAND STORY — with product grid instead of brand-mood */}
      <section className="py-24 max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <p className="section-subtitle mb-4">Notre mission</p>
            <h2 className="section-title mb-6">Inspirée par la nature,<br/><em className="text-[#E07B39]">créée pour votre couronne</em></h2>
            <div className="w-16 h-0.5 bg-[#D4A843] mb-6"/>
            <p className="font-body text-base text-[#6B6B6B] leading-relaxed mb-4">
              Afro Queens est née d&apos;un constat simple : les cheveux afro, bouclés et crépus manquent cruellement de soins vraiment adaptés à leur nature unique. Trop souvent négligés par les marques conventionnelles, ils méritent pourtant une attention royale.
            </p>
            <p className="font-body text-base text-[#6B6B6B] leading-relaxed mb-8">
              Nous avons donc créé des formules qui s&apos;inspirent des savoirs ancestraux africains, enrichis d&apos;actifs botaniques de haute performance — parce que chaque couronne mérite le meilleur.
            </p>
      ...
      <section className="py-24 bg-[#F5F0EA]">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            <p className="section-subtitle mb-4">Nos Best-sellers</p>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            <p className="section-subtitle mb-4">La famille des reines</p>
            <h2 className="section-title">Ce qu&apos;elles en pensent</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((t,i) => (
              <div key={i} className="bg-[#F5F0EA] p-8 relative">
      ...
      {/* CTA BANNER — dark bg + strong contrast */}
      <section className="relative py-24 overflow-hidden" style={{backgroundColor:'#1A0F00'}}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-4">
          ...
          <h2 className="font-script text-4xl md:text-6xl text-white mb-6">
            Votre couronne.<br />Notre mission.
          </h2>
          <p className="text-white/90 font-sans text-sm mb-10 leading-relaxed max-w-xl mx-auto">
