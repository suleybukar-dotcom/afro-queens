...
export const products: Product[] = [
  {
    ...
    price: 34.90, originalPrice: 44.00, category: "Soin lavant", badge: "Bestseller",
  ...
  },
  {
    ...
    name: "Sérum Huileux Cuir Chevelu", tagline: "L'or liquide pour votre couronne",
    price: 48.90, category: "Soin intensif", badge: "Nouveau",
  ...
  },
  {
    ...
    price: 27.90, category: "Hydratation",
  ...
  },
  {
    ...
    price: 44.90, category: "Traitement intensif",
    description: "Notre Masque Capillaire Reconstituant est le traitement ultime pour les cheveux très abîmés, décolorés ou surtraités. Une formule concentrée et enveloppante, inspirée des rituels de beauté africains ancestraux, qui répare, reconstruit et ressource les fibres capillaires en un seul soin. Après un seul masque, vos cheveux retrouvent souplesse, brillance et résistance.",
...
export const faqs = [
  ...
  { question: "Combien de temps durent les livraisons ?", answer: "Les commandes sont expédiées sous 48-72h ouvrées. La livraison standard prend 3-5 jours ouvrés au Canada. Une option express est disponible au checkout." },
  ...
  { question: "Comment contacter le service client ?", answer: "Vous pouvez nous contacter par email à mbouoh@gmail.com, ou directement via WhatsApp au +1 (613) 307-9593 pour une réponse rapide." }
];

export const contactInfo = {
  phone: "+1 (613) 307-9593",
  whatsapp: "16133079593",
  whatsappDisplay: "+1 (613) 307-9593",
